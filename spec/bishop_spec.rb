...
describe Bishop do
  describe '#available_moves' do
    ...
    it 'returns 2 moves' do
      cb = Chessboard.new
      cb.place_chess_piece(Bishop.white, ChessPosition.from_s('c3'))
    ...
    it 'returns 1 move' do
      cb = Chessboard.new
      cb.place_chess_piece(Bishop.black, ChessPosition.from_s('c3'))
      cb.place_chess_piece(Bishop.white, ChessPosition.from_s('c5'))
      cb.place_chess_piece(Bishop.white, ChessPosition.from_s('e3'))
      cb.place_chess_piece(Bishop.white, ChessPosition.from_s('e5'))
    ...
    it 'returns 0 moves (empty array)' do
      cb = Chessboard.new
      cb.place_chess_piece(Bishop.white, ChessPosition.from_s('b2'))
